...
MODIFICATION OF URBANSOUND8K DATASET
====================================


This dataset is a modification of the UrbanSound8K data set[1]. All credits go to the original 
authors. It was created for the purpose of serving as a training dataset for a sound classification 
task using artificial neural networks. The work can be found on Github under [2].

Modifications include:

** 1. Samples were converted to 16bit 8,000Hz mono using ffmpeg.
** 2. Samples were sorted into subfolders according to their class.
** 3. Only samples of exactly four seconds length were included.
** 4. Samples were labeled corresponding to which set we used them for: training, validation, testing.
** 5. The 'gun_shot' class was excluded because it contained only 16 samples of 4s length.

The .wav-files can be found in the sub-directory 'audio'. 

We have furthermore exported the data as a pickle file to ease working with it in python. The 
pickle file can be found in the sub-directory 'pickle'.
...
[1]  J. Salamon, C. Jacoby and J. P. Bello, "A Dataset and Taxonomy for Urban Sound Research", 
     22nd ACM International Conference on Multimedia, Orlando USA, Nov. 2014.
[2]  https://github.com/verrannt/TF_CNN_SoundVis




#-----------------------------------------------------------------------------------------------------#
# README OF THE ORIGINAL DATASET                                                                      #
#-----------------------------------------------------------------------------------------------------#
